...
{
    public class StageContainerItem : ItemContainerAggregate<IDDDItem>, IDDDItem, IScript<ItemScript>
    {
        public StageContainerItem() { }

        public StageContainerItem(int x, int y, string description = "")
